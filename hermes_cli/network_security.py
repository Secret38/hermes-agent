"""Sanitized outbound-network posture for Agent OS operator surfaces."""
...
def network_security_summary(config: object, *, model: object = None, runtime: object = None) -> dict[str, Any]:
    ...
    return {
        ...
        "browser": {"class": "unknown", "reason": "user_directed_destinations"},
        "computer_use": {"class": "unknown", "reason": "controlled_app_egress_not_observable"},
        "messaging": {"class": "unknown", "reason": "no_narrow_runtime_authority"},
        "updates": {"class": "external", "mode": "on_demand"},
    }
